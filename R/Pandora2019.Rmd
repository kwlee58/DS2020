...
`r include_graphics("../pics/pandora1903.jpg", dpi = 240)`
...
이 된다. 또는 텍스트 라벨 12.6의 위치를 25% + 27.8% 에서 12.6%의 반을 더한 것으로 이해하여도 된다. 이 때의 식은 $25 + 4.5 + 12.6/2)\times\times\frac{1}{100}2\pi$으로 표현할 수 있다. 텍스트 라벨 4.5의 위치는 25%에서 4.5%의 반을 더한 위치, $(25 + 4.5/2)\times\frac{1}{100}\times2\pi$이 된다.
...
#> 도표 안 레이블의 좌표 계산. 시계 방향인 점과 시작점이 90도 각도인 점이 어덯게 코드에 반영되는지 유의.
