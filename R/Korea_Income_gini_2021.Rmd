...
knitr::include_graphics("../pics/Labor_Income_2021.png")
```

```{r, data, highlight = FALSE}
income_kr_data <- 
  read_excel("../data/Labor_Income_2021.xlsx", 
             range = "A1:E15", 
             col_names = FALSE)
income_kr_data %<>% 
  data.frame
...
```{r, fig.width = 6, fig.height = 6}
c12
ggsave("../pics/cumulative_plot_wage_kr_2021.png", width = 8, height = 8, dpi = 300)
```
...
g12
ggsave("../pics/lorenz_curve_wage_kr_2021.png", width = 8, height = 8, dpi = 300)
```
