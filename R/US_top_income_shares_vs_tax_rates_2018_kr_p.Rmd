...
dev.copy(png, 
         file ="../pics/US_Top_Income_Share_vs_MTR_kr_wide_2018.png",
         width = 960, 
         height = 540)
dev.off()
``` 
...
text(x = 1998, 
     ...
     cex = 1.2)
dev.copy(png, 
         file ="../pics/US_Top_Income_Share_vs_inverse_MTR_kr_2018.png",
         width = 960, 
         height = 540)
dev.off()
``` 
...
text(x = 1925, 
     ...
     cex = 1.2)
dev.copy(png, 
         file ="../pics/US_Income_Growth_vs_MTR_kr_2018.png", 
         width = 960, 
         height = 540)
dev.off()
```
...
text(x = 1925, 
     ...
     cex = 1.2)
dev.copy(png, 
         file ="../pics/US_Income_Growth_vs_MTR_K_kr_2018.png", 
         width = 960, 
         height = 540)
dev.off()
```
