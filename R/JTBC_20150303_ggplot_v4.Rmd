...
library(systemfonts)
library(showtext)
font_add_google("Nanum Gothic", "nanum", bold.wt = 700)
showtext_auto()
```
...
```{r, echo = TRUE, out.width = "48%", fig.align = "default"}
...
x_text[1] <- 0.75
y_text[1] <- 0
pander(t(as.matrix(poll)), caption = "김영란법 국회 통과")
```
...
```{r, out.width = "100%", fig.width = 7, fig.height = 4, fig.align = "center", eval = TRUE}
library(ggplot2)
pos2 <- pos
