...
# system(command = "wget http://www.kopus.org/download/KOPUBWORLD_TTF_FONTS.zip")
# system(command = "unzip KOPUBWORLD_TTF_FONTS.zip -d KoPubWorld")
# system(command = "rm -f KOPUBWORLD_TTF_FONTS.zip")
```
...
```{r, mac_pie, out.width = "67%", fig.align = "center", fig.showtext = TRUE, eval = FALSE}
library(systemfonts)
# mac 용
system("fc-list | grep KoPub")
system("fc-list | grep Nanum")
...
```{r, windows_pie, out.width = "67%", fig.align = "center", fig.showtext = TRUE, eval = TRUE}
library(systemfonts)
# Font 경로를 알아내는 코드
# Windows 용이니 mac 사용자는 "C:/"를 지우고 자신의 환경에 맞게 설정.
# subset(system_fonts(), grepl("KoPub", family))
# system_fonts()[214:219, "path"]
subset(system_fonts(), grepl("Malgun", family))
font_add(family = "kopub", 
         regular = "c:/Users/hallym/AppData/Local/Microsoft/Windows/Fonts/KoPubWorld Dotum Medium.ttf",
         bold = "c:/Users/hallym/AppData/Local/Microsoft/Windows/Fonts/KoPubWorld Dotum Bold.ttf",
         italic  = "c:/Users/hallym/AppData/Local/Microsoft/Windows/Fonts/KoPubWorld Dotum Light.ttf")
showtext_auto()
font_add(family = "malgun", 
         regular = "C:\\Windows\\Fonts\\malgun.ttf",
         bold = "C:\\Windows\\Fonts\\malgunbd.ttf",
         italic = "C:\\Windows\\Fonts\\malgunsl.ttf")
showtext_auto()
suppressMessages({
par(family = "malgun")
# par(family = "kopub")
...
text(x = 2.1 * x_text0, y = 2.1 * y_text0, 
     ...
     col = "white", 
     cex = 1.5)
title(main = "김영란법\n국회 통과", cex.main = 2, family = "malgun")
box(which = "figure", lwd = 3)
dev.copy(png, "../pics/jtbc150303.png", width = 480, height = 480)
invisible(dev.off())
})
...
#  guides(fill = guide_legend(title = "", reverse = TRUE)) +
  ...
  theme(axis.ticks = element_blank(),
        ...
        legend.text = element_text(family = "nanum"),
...
```{r, out.width = "75%", fig.align = "center", eval = TRUE}
library(ggplot2)
pos <- cumsum(poll) - poll / 2
pos2 <- pos
pos2[1] <- 25
...
#  guides(fill = guide_legend(title = "", reverse = TRUE)) +
  ...
  theme(axis.ticks = element_blank(),
        axis.text = element_blank(),
        legend.text = element_text(family = "malgun"),
        panel.background = element_rect(colour = "black"),
