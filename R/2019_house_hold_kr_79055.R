...
mdis <- read.table("2019_분기자료(2019~) - 전체가구_1인이상_20221022_79055.csv", header=FALSE, sep=",", colClasses = c("character"
, "numeric", "numeric", "numeric", "numeric"), na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))



colnames(mdis) = c("가구일련번호"
, "소득", "가계지출금액", "가계지출_소비지출금액", "가계지출_비소비지출금액")
