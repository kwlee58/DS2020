...
library(knitr)
library(showtext)
font_install(source_han_serif(lang = "KR"))
font_installed()
font_families()
font_paths()
...
# system(command = "wget https://www.kopus.org/wp-content/uploads/2021/03/KOPUBWORLD_TTF_FONTS-1.zip")
...
text(x = 2.1 * x_text0, y = 2.1 * y_text0, 
     ...
     col = "white", 
     cex = 1.5)
title(main = "김영란법\n국회 통과", cex.main = 2, family = "wqy-microhei")
...
```{r, out.width = "75%", fig.align = "center", fig.showtext = TRUE}
library(ggplot2)
pos <- cumsum(poll) - poll / 2
pos2 <- pos
pos2[1] <- 25
...
#  guides(fill = guide_legend(title = "", reverse = TRUE)) +
  ...
  theme(axis.ticks = element_blank(),
        ...
        legend.text = element_text(family = "wqy-microhei"),
