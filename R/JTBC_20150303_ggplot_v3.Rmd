...
font_add(family = "KoPubWorld Dotum Medium", 
         regular = "C:/Users/kwlee/AppData/Local/Microsoft/Windows/Fonts/KoPubWorld Dotum Medium.ttf")
font_add(family = "KoPubWorld Dotum Bold", 
         regular = "C:/Users/kwlee/AppData/Local/Microsoft/Windows/Fonts/KoPubWorld Dotum Medium.ttf")
# showtext_auto()
par(family = "KoPubWorld Dotum Medium")
pie(poll, 
    labels = "", 
    radius = 1,
    clockwise = TRUE, 
...
text(x = 2.1 * x_text0, y = 2.1 * y_text0, 
     ...
     col = "white", 
     cex = 1.5)
title(main = "김영란법\n국회 통과", cex.main = 2, family = "KoPubWorld Dotum Bold")
...
#  guides(fill = guide_legend(title = "", reverse = TRUE)) +
  ...
  theme(axis.ticks = element_blank(),
        ...
        legend.text = element_text(family = "KoPubWorld Dotum Medium"),
        panel.background = element_rect(colour = "black"),
        plot.title = element_text(family = "KoPubWorld Dotum Bold", 
                                  size = 20, 
                                  vjust = -10,
                                  hjust = 0.5)) +
  coord_polar(theta = "y")
