...
axis(side = 2,
     at = Cum, 
     labels = format(Cum, digits = 4, nsmall = 1),
     las = 2)
horsekick %$%
...
axis(side = 2,
     ...
     labels = c("", format(horsekick$Cum[1:4], digits = 4, nsmall = 1), ""),
     las = 2)
...
```{r fig.width = 5.5, fig.height = 5.5}
# par(family = "KoPubWorldDotum Medium")
source("horsekick_plot_v3.R", echo = TRUE)
apply(h_xy, MARGIN = 1, 
...
$= 0\times0.514 + 1\times(0.839-0.514) + 2\times(0.954-0.839) + 3\times(0.993-0.954) + 4\times(1-0.993)$
...
source("horsekick_plot_v3.R", echo = FALSE)
