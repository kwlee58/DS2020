...
`Class_roll_170303_data_maskingv4.Rmd`에서 생성한 `class_roll_170303_masked.RDS`를 읽어들인다. txt 파일을 읽어들일 때 발생하는 인코딩 관련 문제들을 해결하는 가장 R 사용자다운 방법이다.
...
email_list <- strsplit(class_roll$email, 
                       split = "@", 
                       fixed = FALSE) ## fixed = FALSE 가  default
