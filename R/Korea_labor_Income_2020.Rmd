...
income_kr_dat <- 
  "../data/Korea_labor_income_2020.txt" %>% 
...
lines(x = c(0, 13.0), y = rep(50, 2), col = "red", lwd = 2)
arrows(x0 = 13.0, y0 = 50, x1 = 13.0, y1 = 0, length = 0.15, col = "red", lwd = 2)
text(x = 40, y = 25, labels = "Median Income", srt = 30, col = "red")
title(main = title_2, xlab = xlab_2, ylab = ylab_2)
```
...
abline(h = 94.4, lty = 3, col = "red")
axis(side = 2, at = 94.4, label = 94.4, las = 1)
title(main = title_3, xlab = xlab_2, ylab = ylab_3)
```
...
(c9 <- c8 +
    annotate("segment", x = 0, xend = 13.4, y = 50, yend = 50, colour = "red", size = 1))
(c10 <- c9 +
    geom_segment(data = data.frame(x1 = 13.4, x2 = 13.4, y1 = 50, y2 = 0),
