---
title: "R Programming 02 Class Roll Personal Info Masked"
author: "coop711"
date: "`r Sys.Date()`"
...
```{r, data}
class_roll <- read.xlsx("../data/class_roll_02.xlsx", 1, startRow = 2, endRow = 34, colIndex = c(3:7, 9), colClasses = rep("character", 6), encoding = "UTF-8", stringsAsFactors = FALSE)
...
<!--
```{r, save}
write.table(class_roll, file ="../data/class_roll_02_masked.txt")
save.image("../R/class_roll_02_data_masked.RData")
```
-->