...
c12
ggsave("../pics/cumulative_plot_after_tax_income_kr_2021.png", width = 8, height = 8, dpi = 300)
```
...
g12
ggsave("../pics/lorenz_curve_after_tax_income_kr_2021.png", width = 8, height = 8, dpi = 300)
```
