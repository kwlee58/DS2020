...
```{r, fig.width = 8, fig.height = 4}
showtext_auto()
font_add(family = "wqy-microhei",
         regular = "C:/Users/kwlee/AppData/Local/Microsoft/Windows/Fonts/wqy-microhei.ttc")
...
```{r, fig.height = 4, fig.width = 8}
(g6 <- g5 +
  theme(plot.title = element_text(family = "wqy-microhei", 
                                  size = 25, 
                                  hjust = 0.5)))
(g7 <- g6 +
