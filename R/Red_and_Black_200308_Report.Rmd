---
title: "Randomization Report (200308)"
author: "coop711"
date: "`r Sys.Date()`"
...
load("./red_and_black_200308_data.RData")
str(class_roll)
```
...
```{r, year, echo = FALSE}
class_roll$year %>%
  factor(labels = c("1학년", "2학년", "3학년", "4학년")) %>%
  table(class_roll$group, .) %>%
  pander
...
save.image("../R/red_and_black_200308_data.RData")
```
