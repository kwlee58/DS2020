...
sysfonts::font_add_google(name = "Nanum Gothic", family = "nanum", bold.wt = 700)
showtext_auto()
```

```{r cars}
median <- 
  c(17.5, 17.7, 18.8, 20.8, 21.6, 23.0, 23.4, 24.6, 26.0, 27.2, 28.3, 28.9, 29.7)
average <- 
  c(25.8, 26.4, 28.2, 29.8, 30.7, 32.0, 32.8, 33.9, 35.4, 36.6, 37.6, 38.5, 40.4) 
gini <- 
  c(0.494, 0.506, 0.489, 0.475, 0.474, 0.465, 0.466, 0.46, 0.456, 0.446, 0.438, 0.440, 0.445)
year <- 2009:2021
L <- length(year)
...
title(main = "평균소득과 중위소득", cex.main = 1.8, font.main = 2)
...
title(main = "급여총계의 지니계수", cex.main = 1.8, font.main = 2)
