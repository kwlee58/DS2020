---
title: "Korea Income Distribution 2009"
author: "coop711"
date: "`r Sys.Date()`"
...
knitr::include_graphics("../pics/Labor_Income_2009.png")
```

```{r, data, highlight = FALSE}
income_kr_data <- 
  read_excel("../data/Labor_Income_2009.xlsx", 
             range = "A1:E21", 
             col_names = FALSE)
income_kr_data %<>% 
  data.frame
...
title_4 <- "Lorenz Curve of Korea Wage Earners' Income 2009"
...
```{r, fig.width = 6, fig.height = 6}
c12
ggsave("../pics/cumulative_plot_wage_kr_2009.png", width = 8, height = 8)
```
...
g12
ggsave("../pics/lorenz_curve_wage_kr_2009.png", width = 8, height = 8)
```
