...
```{r, message = FALSE, fig.width = 3.2, fig.height = 3.2}
p3 <- p2 + theme_bw(base_family = "KoPubWorldDotum Medium")
# + theme_kr
p3 
p4 <- p3 + 
  scale_x_discrete(name = "찬반") +
...
Vote_seoul_Class_p_df$label_height <- unlist(tapply(Vote_seoul_Class_p_df$height, Vote_seoul_Class_p_df[, 2], function(x) cumsum(x) - x / 2))
